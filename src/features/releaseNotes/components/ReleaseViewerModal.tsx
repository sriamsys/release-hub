                ...
                <Stack spacing={4} alignItems="flex-start">
                  <Stack direction="row" spacing={2} alignItems="center">
                    ...
                    <Typography variant="caption" sx={{ color: 'slate.400', fontWeight: 600, letterSpacing: '0.05em' }}>
                      SYSTEM ANNOUNCEMENT • v{note.version}
                    </Typography>
                  </Stack>
                  ...
                  <Box sx={{ maxWidth: '900px' }}>
                    ...
                    <Stack direction="row" spacing={1.5} flexWrap="wrap">
                      <AppStatusChip label={note.audience} variant="filled" sx={{ bgcolor: 'rgba(255,255,255,0.1)', color: 'white' }} />
                      <AppStatusChip label={note.releaseType} variant="filled" sx={{ bgcolor: 'rgba(255,255,255,0.1)', color: 'white' }} />
                      <AppStatusChip label={note.status} status={note.status === 'Published' ? 'success' : 'warning'} />
                    </Stack>
                  </Box>
                </Stack>
              </motion.div>
                          ...
                          <Stack spacing={2.5}>
                            <Stack direction="row" spacing={2} alignItems="center">
                              ...
                              <Box>
                                ...
                                <Typography variant="body2" sx={{ fontWeight: 700 }}>{note.createdBy}</Typography>
                              </Box>
                            </Stack>
                            ...
                            <Stack direction="row" spacing={2} alignItems="center">
                              ...
                              <Box>
                                ...
                                <Stack direction="row" spacing={0.5} flexWrap="wrap" pt={0.5}>
                                  {note.tags.map(t => <Chip key={t} label={t} size="small" sx={{ height: 20, fontSize: '10px', fontWeight: 800 }} />)}
                                </Stack>
                              </Box>
                            </Stack>
                          </Stack>
                    ...
                    <Box sx={{ p: { xs: 4, md: 8 }, bgcolor: 'white' }}>
                      ...
                      <Stack direction="row" justifyContent="space-between" alignItems="center">
                        <Typography variant="caption" color="text.secondary">
                          End of Bulletin • Internal Reference #{note.id.substring(0, 8).toUpperCase()}
                        </Typography>
